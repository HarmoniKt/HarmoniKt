...
def request_status_to_spot_with_sdk(robot, robot_state_client):
    ...
    odom_tform_body.get_translation()
...
def register_robots_in_harmonikt():
    ...
    try:
        ...
        # Create POI
        poi_data = {"name": "ok", "latitude": 1.0, "longitude": 2.0}
        ...
        # Create MIR marker
        mir_marker_data = {
            "identifier": "81efdb9c-36e3-11f0-9bd3-000e8e9899fd",
            "type": "MIR",
        }

        response = requests.post(
            f"{harmonikt_url}/pois/{poi_id}/markers", json=mir_marker_data
        )
        response.raise_for_status()
...
TEST = "spot-harmonikt"  # 'spot-sdk' or 'spot-harmonikt' or 'mir-sdk' or 'mir-harmonikt'
